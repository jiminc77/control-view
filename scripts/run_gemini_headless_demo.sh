...
case "$BASELINE" in
  B0) DEFAULT_PROMPT_FILE="$ROOT/docs/gemini_prompt_b0.md" ;;
  B1) DEFAULT_PROMPT_FILE="$ROOT/docs/gemini_prompt_b1.md" ;;
  B3) DEFAULT_PROMPT_FILE="$ROOT/docs/gemini_prompt_b3.md" ;;
  *)
